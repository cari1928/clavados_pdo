...
CREATE TABLE `clavado` (
  ...
  `clavado` varchar(150) DEFAULT NULL,
...
CREATE TABLE `orden_clavados` (
  ...
  `numero_ronda` int(11) DEFAULT NULL,
...
CREATE TABLE `ronda` (
  ...
  `cve_clavadista` varchar(7) NOT NULL,
  `calif_ronda` float DEFAULT NULL,
  PRIMARY KEY (`num_ronda`,`cve_clavadista`),
  KEY `rondaFK` (`cve_clavadista`),
  CONSTRAINT `rondaFK` FOREIGN KEY (`cve_clavadista`) REFERENCES `clavadista` (`cve_clavadista`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-11-27 21:58:18
